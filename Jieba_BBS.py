...
comments_list = []
with open("E:/AB104/PPT-nullJieba/pttcontent7.json","r") as a:
    Com_list = json.load(a)
    # print Com_list
    for i in Com_list:
        # print i["content"]
        comments_list.append(i["content"])
...
with open('E:/AB104/PPT-Jieba/pttcontent7.txt','w') as output:
    for index,content in enumerate(comments_list):
        print content
        upperline = content.upper().replace(' ','')
#         print upperline
